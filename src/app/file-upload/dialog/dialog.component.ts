...
import { FileUploadResponse, Message } from '../models/fileUploadResponse';
...
export class DialogComponent implements OnInit {
  ...
  closeDialog() {
    ...
    for (const key in this.progress) {
      ...
      this.progress[key].body.subscribe((val:FileUploadResponse) => this.uploadMessages.push(val.messages[0]));
    }
